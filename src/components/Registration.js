...
const Registration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (data.Status === true) {
      ...
      Swal.fire({
        ...
        text: `${Form.fname} added to ${Form.course}.`,
      });
      navigate("/Sign");
    } else {
  ...
  return (
    <>
      <div className="min-w-1000 min-h-full pt-5 bg-white flex items-center justify-center">
        <div className="bg-gray-100 text-gray-500 rounded-xl md:rounded-3xl shadow-lg mx-5 mb-10  w-full overflow-hidden m-w-1000">
          <div className="md:flex  w-full">
            ...
            <div className="w-full md:w-1/2 md:py-10 py-auto p-3  md:px-10">
              ...
              <div>
                <form className="" onSubmit={handleSubmit}>
                  <div className="flex -mx-3 md:flex-row flex-col">
                  ...
                  <div className="flex -mx-3">
                    ...
                    <div className="w-1/2 px-3 mb-12">
                      <label for="cars" className="text-xs font-semibold px-1">
                        Choose a course:
                      </label>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-2  grid place-content-center">
                      <button
                        type="submit"
